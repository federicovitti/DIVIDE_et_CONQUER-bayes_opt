...
from hartmann3_bo import y_bo, err_bo, times_bo
from hartmann3_ebo import y_EBO, err_EBO, times_EBO
from hartmann3_my import y_bests, errs, times
...
fig.savefig('h3ERR.png')
fig3.savefig('h3TIME.png')