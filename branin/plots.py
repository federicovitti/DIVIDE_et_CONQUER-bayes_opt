...
from branin_bo import y_bo, err_bo, times_bo
from branin_ebo import y_EBO, err_EBO, times_EBO
from branin_my import y_bests, errs, times
...
for m in range(len(methods)):
	...
	fig1.legend(loc=1, labelspacing= 0.1, frameon=False)
...
fig4.legend(loc=1, labelspacing=0.1, frameon=False) 
...
fig.savefig('braninERR.png')
fig3.savefig('braninTIME.png')