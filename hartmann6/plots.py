...
from hartmann6_bo import y_bo, err_bo, times_bo
from hartmann6_ebo import y_EBO, err_EBO, times_EBO
from hartmann6_my import y_bests, errs, times
...
fig.savefig('h6ERR.png')
fig3.savefig('h6TIME.png')