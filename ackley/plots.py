...
from ackley_bo import y_bo, err_bo, times_bo
from ackley_ebo import y_EBO, err_EBO, times_EBO
from ackley_my import y_bests, errs, times
...
fig.savefig('ackleyERR.png')
fig3.savefig('ackleyTIME.png')